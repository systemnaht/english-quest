...
export default async function handler(req,res){
  ...
  const prompt=`Evaluate this English learner answer at ${level}. Be tolerant of natural equivalent wording but correct grammar and meaning. Exercise: ${JSON.stringify(exercise).slice(0,3500)} Learner answer: ${JSON.stringify(answer)}. Return JSON only: {"correct":true|false,"feedback":"brief German feedback","better":"best natural English version"}.`;
  try{
